...
import { getPrompt, listPrompts, registerPrompt } from "./utils/prompt-factory.js";
import { ConnectionMonitor, RateLimiter, validateMessageSize } from "./utils/security.js";
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request, extra) => {
      ...
      try {
        ...
        if (error instanceof z.ZodError) {
          const formattedErrors = error.errors.map((e: z.ZodIssue) => {
