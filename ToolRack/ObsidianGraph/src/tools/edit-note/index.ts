...
import { z } from "zod";
import { createNoteNotFoundError, ensureMarkdownExtension, fileExists, handleFsError, validateVaultPath } from "../../utils/files.js";
import { FileOperationResult, createToolResponse, formatFileResult } from "../../utils/responses.js";
...
const deleteSchema = z.object({
  ...
  folder: z.string()
    .optional()
    .refine((folder: string | undefined) => !folder || !path.isAbsolute(folder),
